...
//获取所有地点的li
let map = document.querySelectorAll('.Et-place li');

//添加点击事件，删除上下的div
map.forEach(index => {
    index.addEventListener('click',()=>{
        document.querySelector('.Exhibition-main-m').style.display="none";
        let f = document.querySelectorAll('.FR-all');
        f.forEach(ixn => {
            ixn.style.display="none";
        })
    })
});
